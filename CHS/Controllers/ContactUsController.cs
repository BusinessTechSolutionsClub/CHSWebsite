...
namespace CHS.Controllers
{
    public class ContactUsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Address,CellPhoneNumber,HoursOfOperation")] ContactUs contactUs)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Address,CellPhoneNumber,HoursOfOperation")] ContactUs contactUs)
        {
            if (ModelState.IsValid)
            {
